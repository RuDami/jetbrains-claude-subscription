...
- сколько места занято и кнопка **Clean Up** — диалог со списком скачанных версий и их
  размерами, где можно отметить нужные или снести все разом; используемая версия в список
  не попадает вовсе;
